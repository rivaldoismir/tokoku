...
-- Dumping database structure for tokoku2
CREATE DATABASE IF NOT EXISTS `tokoku2` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `tokoku2`;

-- Dumping data for table tokoku2.barang: ~5 rows (approximately)
...
-- Dumping data for table tokoku2.kategori: ~3 rows (approximately)
